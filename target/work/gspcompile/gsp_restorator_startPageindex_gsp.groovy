...
invokeTag('link','g',81,['action':("searchCafee"),'params':([city: "Архангельск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(27, 2)
invokeTag('link','g',82,['action':("searchCafee"),'params':([city: "Белгород"])],2)
printHtmlPart(26)
createClosureForHtmlPart(28, 2)
invokeTag('link','g',83,['action':("searchCafee"),'params':([city: "Брянск"])],2)
printHtmlPart(29)
createClosureForHtmlPart(30, 2)
invokeTag('link','g',85,['action':("searchCafee"),'params':([city: "Владимир"])],2)
printHtmlPart(26)
createClosureForHtmlPart(31, 2)
invokeTag('link','g',86,['action':("searchCafee"),'params':([city: "Геленджик"])],2)
printHtmlPart(26)
invokeTag('link','g',87,['action':("searchCafee"),'params':([city: "Дмитров"])],-1)
printHtmlPart(32)
createClosureForHtmlPart(33, 2)
invokeTag('link','g',92,['action':("searchCafee"),'params':([city: "Екатеринбург"])],2)
printHtmlPart(26)
createClosureForHtmlPart(34, 2)
invokeTag('link','g',93,['action':("searchCafee"),'params':([city: "Зарайск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(35, 2)
invokeTag('link','g',94,['action':("searchCafee"),'params':([city: "Звенигород"])],2)
printHtmlPart(26)
createClosureForHtmlPart(36, 2)
invokeTag('link','g',95,['action':("searchCafee"),'params':([city: "Ижевск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(37, 2)
invokeTag('link','g',96,['action':("searchCafee"),'params':([city: "Йошкар-Ола"])],2)
printHtmlPart(26)
createClosureForHtmlPart(38, 2)
invokeTag('link','g',97,['action':("searchCafee"),'params':([city: "Казань"])],2)
printHtmlPart(39)
createClosureForHtmlPart(40, 2)
invokeTag('link','g',102,['action':("searchCafee"),'params':([city: "Киров"])],2)
printHtmlPart(26)
createClosureForHtmlPart(41, 2)
invokeTag('link','g',103,['action':("searchCafee"),'params':([city: "Липецк"])],2)
printHtmlPart(26)
createClosureForHtmlPart(42, 2)
invokeTag('link','g',104,['action':("searchCafee"),'params':([city: "Лазаревское"])],2)
printHtmlPart(26)
createClosureForHtmlPart(43, 2)
invokeTag('link','g',105,['action':("searchCafee"),'params':([city: "Москва"])],2)
printHtmlPart(26)
createClosureForHtmlPart(44, 2)
invokeTag('link','g',106,['action':("searchCafee"),'params':([city: "Мурманск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(45, 2)
invokeTag('link','g',107,['action':("searchCafee"),'params':([city: "Нижний Новгород"])],2)
printHtmlPart(39)
createClosureForHtmlPart(46, 2)
invokeTag('link','g',112,['action':("searchCafee"),'params':([city: "Новосибирск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(47, 2)
invokeTag('link','g',113,['action':("searchCafee"),'params':([city: "Новороссийск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(48, 2)
invokeTag('link','g',114,['action':("searchCafee"),'params':([city: "Омск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(49, 2)
invokeTag('link','g',115,['action':("searchCafee"),'params':([city: "Петрозаводск"])],2)
printHtmlPart(26)
createClosureForHtmlPart(50, 2)
invokeTag('link','g',116,['action':("searchCafee"),'params':([city: "Самара"])],2)
printHtmlPart(26)
createClosureForHtmlPart(51, 2)
invokeTag('link','g',117,['action':("searchCafee"),'params':([city: "Санкт-Петербург"])],2)
printHtmlPart(52)
})
