...
invokeTag('form','g',47,['class':("form-inline")],2)
printHtmlPart(21)
createTagBody(2, {->
invokeTag('img','g',54,['dir':("images"),'file':("moscow3_w_200.png")],-1)
})
invokeTag('link','g',54,['action':("searchCafee"),'params':([city: "Москва"])],2)
printHtmlPart(22)
createTagBody(2, {->
invokeTag('img','g',57,['dir':("images"),'file':("piter.png")],-1)
})
invokeTag('link','g',57,['action':("searchCafee"),'params':([city: "Санкт Петербург"])],2)
printHtmlPart(22)
createTagBody(2, {->
invokeTag('img','g',60,['dir':("images"),'file':("novosibirsk_web.png")],-1)
})
invokeTag('link','g',60,['action':("searchCafee"),'params':([city: "Новосибирск"])],2)
printHtmlPart(23)
createTagBody(2, {->
invokeTag('img','g',65,['dir':("images"),'file':("novgorod_web.png")],-1)
})
invokeTag('link','g',65,['action':("searchCafee"),'params':([city: "Нижний Новгород"])],2)
printHtmlPart(22)
createTagBody(2, {->
invokeTag('img','g',68,['dir':("images"),'file':("Yekaterinburg_web.png")],-1)
})
invokeTag('link','g',68,['action':("searchCafee"),'params':([city: "Екатеринбург"])],2)
printHtmlPart(22)
createTagBody(2, {->
invokeTag('img','g',71,['dir':("images"),'file':("Samara01_web.png")],-1)
})
invokeTag('link','g',71,['action':("searchCafee"),'params':([city: "Самара"])],2)
printHtmlPart(24)
createClosureForHtmlPart(25, 2)
invokeTag('link','g',81,['action':("searchCafee"),'params':([city: "Нижний Новгород"])],2)
printHtmlPart(26)
createClosureForHtmlPart(27, 2)
invokeTag('link','g',104,['action':("searchCafee"),'params':([city: "Москва"])],2)
printHtmlPart(28)
...
public static final long LAST_MODIFIED = 1430939416939L
