...
class gsp_restorator_registrationerror_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/registration/error.gsp" }
public Object run() {
Writer out = getOut()
...
else if(true && (error == 19)) {
printHtmlPart(17)
}
else if(true && (error == 20)) {
printHtmlPart(18)
}
else {
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1434306991412L
